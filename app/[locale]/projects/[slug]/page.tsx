            ...
            >
              ...
              >
                ...
                <div>
                  ...
                  <div className="text-2xl font-bold text-primary">{project.client}</div>
                </div>
              </motion.div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {project.results[locale as 'en' | 'ar'].map((result, index) => {
                // Extract percentage/number from result string
                const match = result.match(/(\d+)%?/);
                const number = match ? match[1] : '';
                const text = result.replace(/\d+%?\s*/, '');
                        ...
                        <div className="relative mb-6">
                          ...
                          >
                            <span className="bg-gradient-to-br from-primary via-primary/80 to-primary/60 bg-clip-text text-transparent">
                              {number}
                              {result.includes('%') && <span className="text-5xl">%</span>}
                              {result.includes('+') && <span className="text-5xl">+</span>}
                            </span>
                          </motion.div>
              ...
              >
                ...
                <p className="text-xl text-muted-foreground leading-relaxed">
                  {locale === 'en'
                    ...
                    : 'انضم إلى مئات العملاء الراضين الذين حققوا نتائج رائعة. دعنا نصنع شيئاً استثنائياً معاً.'
                  }
                </p>
                ...
                <div className="space-y-4">
                  {[
                    ...
                    locale === 'en' ? 'Custom solutions' : 'حلول مخصصة',
                    locale === 'en' ? 'Proven results' : 'نتائج مثبتة',
                  ].map((feature, index) => (
                    <motion.div
                      key={index}
                      initial={{ opacity: 0, x: 20 }}
                ...
                <Link href={`/${locale}/contact`}>
                  <motion.div
                    ...
                    whileTap={{ scale: 0.95 }}
                  >
                    <Button variant="neon" size="xl" className="group relative overflow-hidden w-full md:w-auto">
